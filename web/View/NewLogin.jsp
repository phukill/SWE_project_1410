<%-- 
    Document   : NewLogin
    Created on : Jun 24, 2020, 10:57:58 PM
    Author     : Phu Cong
--%>
    ...
    <body>
        <div class="login-dark">
            <form action="${pageContext.request.contextPath}/LoginController" method="POST" style="margin:auto">
                ...
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit">Log In</button></div><a href="RegisterForLogin.jsp" class="forgot">Don't have any account yet? Time to register!</a>
            </form>
        </div>
